/**
 * Small inline stroke icons (lucide-style paths), shared across team components.
 * Kept here so TeamAnalysis and ThreatMatchup render identical pin/rotate glyphs.
 */
