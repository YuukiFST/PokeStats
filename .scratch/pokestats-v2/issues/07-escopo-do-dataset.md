...
1. **Dex Generation** — o V1 lia só `sv`. O usuário mencionou `xy`, `sm`, `ss` (e "Champions", que
   não é uma Dex Generation do Smogon). Base Stats de uma Form podem diferir entre gerações, então
   embutir várias significa versionar stats por geração, não só Sets. Uma só, ou várias?
